...
class CaloryRequirement extends StatefulWidget {
  @override
  _CaloryRequirementState createState() => _CaloryRequirementState();
}

class _CaloryRequirementState extends State<CaloryRequirement> {
  int height = 180;
  int age = 40;
  int wt = 100;
  ...
  late CalorieRequirementData data;
  ...
  void initState() {
    ...
    _initBannerAd();
    Mildweightloss mwl = Mildweightloss(calory: 0, lossweight: "no");
    Weightloss wl = Weightloss(calory: 0, lossweight: "no");
    Extremeweightloss ewl = Extremeweightloss(calory: 0, lossweight: "no");
    Mildweightgain mwg = Mildweightgain(calory: 0, gainweight: "no");
    Weightgain wg = Weightgain(calory: 0, gainweight: "no");
    Extremeweightgain ewg = Extremeweightgain(calory: 0, gainweight: "no");
    Goals g = Goals(
        maintainweight: 0,
        mildweightloss: mwl,
        weightloss: wl,
        extremeweightloss: ewl,
        mildweightgain: mwg,
        weightgain: wg,
        extremeweightgain: ewg);
    this.data = CalorieRequirementData(BMR: 0, goals: g);
  }
    _initBannerAd() {
    _bannerAd = BannerAd(
        size: AdSize.banner,
            ...
            Stack(
              children: [
                ...
                Positioned(
                    ...
                    child: Hero(
                      tag: "assets/calrequirement.png",
                      child: Container(
                        decoration: const BoxDecoration(
                            shape: BoxShape.circle,
                            color: Colors.white,
                            image: DecorationImage(
                                image: AssetImage("assets/calrequirement.png"),
                                fit: BoxFit.fitWidth)),
                        height: 200.0,
                        width: 200.0,
                      ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () async {
                        data = await HomePageProvider.calorieRequirementData(
                            age.toString(),
                            gender,
                            height.toString(),
                            wt.toString(),
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text.rich(TextSpan(
                                      text:
                                          'The daily Calorie requirement is shown bolow as per goals',
                                      style: Theme.of(context)
                                          .primaryTextTheme
                                          .subtitle1!
                                          .copyWith(
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      optionWidget(context, 'To Maintain Weight',
                                          '${data.goals.maintainweight}'),
                                      const Divider(
                                        color: Color(0xFF006484),
                                      ),
                                      const SizedBox(
                                      ...
                                      optionWidget1(
                                          ...
                                          '${data.goals.mildweightloss.lossweight}',
                                          '${data.goals.mildweightloss.calory.toStringAsFixed(0)} calories'),
                                      const Divider(
                                        color: Color(0xFF006484),
                                      ),
                                      const SizedBox(
                                      ...
                                      optionWidget1(
                                          context,
                                          'For Weight loss',
                                          '${data.goals.weightloss.lossweight}',
                                          '${data.goals.weightloss.calory.toStringAsFixed(0)} calories'),
                                      const Divider(
                                        color: Color(0xFF006484),
                                      ),
                                      const SizedBox(
                                      ...
                                      optionWidget1(
                                          ...
                                          '${data.goals.extremeweightloss.lossweight}',
                                          '${data.goals.extremeweightloss.calory.toStringAsFixed(0)} calories'),
                                      const Divider(
                                        color: Color(0xFF006484),
                                      ),
                                      const SizedBox(
                                      ...
                                      optionWidget1(
                                          context,
                                          'For Mild Weight gain',
                                          '${data.goals.mildweightgain.gainweight}',
                                          '${data.goals.mildweightgain.calory.toStringAsFixed(0)} calories'),
                                      const Divider(
                                        color: Color(0xFF006484),
                                      ),
                                      const SizedBox(
                                      ...
                                      optionWidget1(
                                          context,
                                          'For Weight gain',
                                          '${data.goals.weightgain.gainweight}',
                                          '${data.goals.weightgain.calory.toStringAsFixed(0)} calories'),
                                      const Divider(
                                        color: Color(0xFF006484),
                                      ),
                                      const SizedBox(
                                      ...
                                      optionWidget1(
                                          context,
                                          'For Extreme Weight gain',
                                          '${data.goals.extremeweightgain.gainweight}',
                                          '${data.goals.extremeweightgain.calory.toStringAsFixed(0)} calories'),
                                      const Divider(
                                        color: Color(0xFF006484),
                                      ),
                                      const SizedBox(
...
Widget optionWidget1(
    BuildContext context, String name, String weight, String name1) {
  return Row(
    children: [
      Text(
        name,
